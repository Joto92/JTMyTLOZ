...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\Zelda\Religions\rel only one\Religion_Demise.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>342607761</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Religion_Demise.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Religion_Demise"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>

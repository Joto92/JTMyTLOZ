...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\Zelda\Religions\rel only one\Religion_GoddessSand.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1051378852</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Religion_GoddessSand.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Religion_GoddessSand"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>

...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="E:\Jordi\Escritorio\ModdingIcons\Zelda\Religions\rel only one\Religion_Majora.dds"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>1489441776</m_ExportedTime>
	<m_ClassName text="UserInterface"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="Religion_Majora.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="Religion_Majora"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
